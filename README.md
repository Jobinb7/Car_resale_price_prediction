Project:To predict the resale price of the car  using python.
 ...
 Data :  Data set : car dataset(https://www.kaggle.com/datasets/shalwalsingha/cars-ds-final)
  ...
  Procedure: 1) After  preprocessing  the data, it's    imported into the MySQL database "car" as table "car_ds".
         ...
         ![image alt](https://github.com/Jobinb7/Car_resale_price_prediction/blob/da7922e67975f0471fe5857193da35952e26fa62/log_raw_regression.PNG
         
         
         ![image alt](https://github.com/Jobinb7/Car_resale_price_prediction/blob/e4f3d80a7c36e99aef742e4314bf7bb183c08fb2/linearRegression_raw1.png)
