...
log_transform_cols = [ 'displacement', 'height', 'length', 'width']
...
print(X_train_raw, X_test_raw, y_train_raw, y_test_raw)
...
joblib.dump(model_pipeline_raw, 'model.pkl')

y_train_pred_raw = model_pipeline_raw.predict(X_train_raw)
print(y_train_pred_raw )
